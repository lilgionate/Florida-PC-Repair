...
const commonProcess = [
  ...
  "If your computer is smoking, stop, drop, and roll! And then turn it off right away. Your hard drive or another part may be up in smoke and well, you know the answer here… it will certainly need to be replaced."
];
    ...
    <div className="mac-power-container">
      <div className="content-container">
        <p className='power-header'>
          Is your hard drive clicking or noisy? Maybe your computer is slow or not opening some files. 
          Stop work right away to avoid further issues and we’ll be happy to replace your drive and ensure your files are safe. 
          Upfront free diagnostics are provided to determine physically failing hard drives and data recovery costs.
        </p>
