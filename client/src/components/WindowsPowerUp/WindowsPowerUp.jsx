    ...
    <div className="mac-power-container">
      <div className="content-container">
        <p className='power-header'>
          Does your computer fail to power on? Or Windows isn’t loading all the way? 
          Our Miami PC experts will perform a free diagnostic, testing all your parts and operating system 
          to determine the exact issue and flat fee repair cost. We are computer experts at determining non-starting PC issues.
        </p>
        <h2>I’m getting no power on my computer.</h2>
        <p className='power-header'>
          This may be as simple as replacing the power supply, battery, charger, or RAM. 
          Or you may have some critical motherboard, laptop jack, or component failure. 
          We do all of the above and are happy to provide a free diagnostic to determine why your computer won’t power on.
        </p>
        <h2>My PC doesn’t load Windows all the way.</h2>
        <p className='power-header'>
          In this case, there’s a little bit more hope in that it’s not a serious catastrophe. 
          You may have a Windows corruption, PC virus infection, or hard drive issue. 
          Allow our PC repair specialists to check this out for you.
        </p>
        <h2>My laptop gets power, but I can’t see anything on the screen.</h2>
        <p className='power-header'>
          This is usually a screen issue and we stock parts in-house for quick laptop screen replacements. 
          Of course, this may also mean the inverter, video connector, or other display issues are present.
        </p>
