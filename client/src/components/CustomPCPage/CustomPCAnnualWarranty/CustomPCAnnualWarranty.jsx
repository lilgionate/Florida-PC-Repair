...
import './CustomPCAnnualWarranty.scss';
...
export default function CustomPCPaymentForm() {
    ...
    const handleSubmitSub = async (e) => {
        ...
        if (result.error) {
            ...
            const res = await axios.post('http://localhost:3000/sub2', { 'payment_method': result.paymentMethod.id, 'name': name });
                ...
                <div className="custom-pc-annual-content">
                    {!success ? (
                        <form ref={form} onSubmit={handleSubmitSub}>
                            <h2 className='custom-pc-warranty-annual-title'>Custom PC Warranty - Annual</h2>
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    id="name"
                                    name="name"
                                    className="custom-pc-annual-input"
                                    required
                                />
                            </div>
                            <div className="mb-4">
                            ...
                            <div className="mb-4">
                                <label htmlFor="warranty" className="custom-pc-annual-label">Custom PC Build Warranty - Annual *</label>
                            ...
                            <div className="mb-4">
                                ...
                                <textarea
                                    ...
                                    className="custom-pc-annual-textarea"
                                />
