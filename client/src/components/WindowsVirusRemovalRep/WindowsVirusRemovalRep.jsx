    ...
    <div className="mac-power-container">
      <div className="content-container">
        <p className='power-header'>
          Is your computer acting strangely? If you suspect a virus on your Windows computer, stop right away to prevent further damage 
        ...
        <h2>Do PCs get more viruses than Macs?</h2>
        <p className='power-header'>
          In one word, yes! There are still more Windows computers being used than Macs. 
          That means that the virus creators look to get more bang for their buck. 
          Viruses may only be created for one type of format, Windows operating systems or Apple operating systems. 
          So, these evil-doers create a virus that will infect the most amount of systems, PC computers. 
          Creating the most havoc is their goal, and our end game here is to ensure you are protected against 
          such maliciousness. That being said, Macs still get viruses and are getting attacked more and more. 
          You are certainly not immune to viruses, trojans, and spyware just because you are a Mac user.
        </p>
        ...
        <p className='power-header2'>
          Nope! 99 out of 100 times we are able to remove the virus so you don’t have to worry about your precious files being erased. 
          The only time we have to reinstall Windows fresh is if your hard drive is failing or if your operating system is corrupted or damaged beyond repair. 
          As for the virus itself, let’s just say that we are a step ahead of the virus creators and believe there is no virus we cannot stop. 
          In essence, we can remove any virus. But, if your operating system or hardware is totally belly up, well, there’s nothing anyone can do but reinstall Windows. 
          Even in the case of reinstalling Windows, we are typically able to salvage all your files. 
          So, whether we have to install Windows or not, we are also experts in data recovery. So, fear not with Florida PC Support!
        </p>
