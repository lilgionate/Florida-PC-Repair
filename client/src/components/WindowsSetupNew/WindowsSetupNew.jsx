    ...
    <div className="mac-power-container">
      <div className="content-container">
        <p className='power-header'>
          ...
          We’ll also transfer your old files over. Need a quick how-to? 
        ...
        <p className='power-header'>
          Sure, we do that too, and do it well we might add. 
          We started out providing onsite computer service for homes and offices so we are onsite new PC set-up experts. 
          You may have a desktop computer or have a lot of different customizations you’d like to set up at your location. 
          Whatever the reason, sometimes, it is easier to have one of our new PC setup techs come to you. 
          We’ll get your new PC up and running, transfer over your old computer files, set up your printer, email, phone, peripherals, and network/internet settings.
        </p>
        <div>
          <RepairCostsSection />
        </div>
