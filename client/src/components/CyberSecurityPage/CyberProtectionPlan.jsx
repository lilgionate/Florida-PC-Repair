        ...
        <h2 className="cyber-security-title">All security protection services are covered within the policy</h2>
                ...
                <h5 className="cyber-security-cursor-pointer" onClick={() => toggleDropdown('dropdown1')}>
                    ...
                    <ul className="cyber-security-dropdown cyber-security-dropdown-open">
                        <p className="cyber-security-dropdown-text">Prone to getting viruses?  Sleep well at night knowing we’ve got your back.
                        </p>
                    </ul>
                )}
            </h5>
            <h5 className="cyber-security-cursor-pointer" onClick={() => toggleDropdown('dropdown2')}>
                        ...
                        {dropdownStates.dropdown2 && (
                    <ul className="cyber-security-dropdown cyber-security-dropdown-open">
                        <p className="cyber-security-dropdown-text">
            ...
            <h5 className="cyber-security-cursor-pointer" onClick={() => toggleDropdown('dropdown3')}>
                        ...
                        {dropdownStates.dropdown3 && (
                    <ul className="cyber-security-dropdown cyber-security-dropdown-open">
                        <p className="cyber-security-dropdown-text">Prevent malicious external traffic and black-hat users.
                        </p>
                    </ul>
                )}
            </h5>
            <h5 className="cyber-security-cursor-pointer" onClick={() => toggleDropdown('dropdown4')}>
                        ...
                        {dropdownStates.dropdown4 && (
                    <ul className="cyber-security-dropdown cyber-security-dropdown-open">
                        <p className="dropdown-text">Hide your online activity from hackers.  Use public Wi-Fi safely with a secure connection.
                        </p>
                    </ul>
                )}
            </h5>
            <h5 className="cyber-security-cursor-pointer" onClick={() => toggleDropdown('dropdown5')}>
                        ...
                        {dropdownStates.dropdown5 && (
                    <ul className="cyber-security-dropdown cyber-security-dropdown-open">
                        <p className="cyber-security-dropdown-text">Your operating system and software will be automatically updated with the latest and versions and updates.  Dated points of vulnerability will be eliminated.
                        </p>
                    </ul>
                )}
            </h5>
            <h5 className="cyber-security-cursor-pointer" onClick={() => toggleDropdown('dropdown6')}>
                        ...
                        {dropdownStates.dropdown6 && (
                    <ul className="cyber-security-dropdown cyber-security-dropdown-open">
                        <p className="cyber-security-dropdown-text">Block certain websites.  Good for child-proofing or keeping your computer focused to the tasks required.
                        </p>
                    </ul>
                )}
            </h5>
            <h5 className="cyber-security-cursor-pointer" onClick={() => toggleDropdown('dropdown7')}>
                        ...
                        {dropdownStates.dropdown7 && (
                    <ul className="cyber-security-dropdown cyber-security-dropdown-open">
                        <p className="cyber-security-dropdown-text">Remote installs, security fixes, virus removals and updates will be done proactively and upon request.
                        </p>
                    </ul>
                )}
            </h5>
            <h5 className="cyber-security-cursor-pointer" onClick={() => toggleDropdown('dropdown8')}>
                        ...
                        {dropdownStates.dropdown8 && (
                    <ul className="cyber-security-dropdown cyber-security-dropdown-open">
                        <p className="cyber-security-dropdown-text">Receive emailed reports to know if any security issues were tended to and what protection was required.
                        </p>
                    </ul>
                )}
            </h5>
